...
- accepted images load directly from the publisher host and are not copied into the repository, transformed by the application or persisted in the database;
