...
function CategoryIcon({ name }: { name: CategoryIconName }) {
  ...
  return (
    <svg viewBox="0 0 24 24" fill="none" aria-hidden="true">
      {name === "cup" ? (
        <>
          <path d="M5 8h11v5.2A4.8 4.8 0 0 1 11.2 18H9.8A4.8 4.8 0 0 1 5 13.2V8Z" {...common} />
          <path d="M16 10h1.5a2.5 2.5 0 0 1 0 5H16M7 5.5c.7-.8.7-1.6 0-2.4M11 5.5c.7-.8.7-1.6 0-2.4" {...common} />
        </>
      ) : null}
      {name === "home" ? (
        <>
      ...
      {name === "heart" ? (
        <>
          <path d="M12 20s-7-4.2-7-10a4.2 4.2 0 0 1 7-3.1A4.2 4.2 0 0 1 19 10c0 5.8-7 10-7 10Z" {...common} />
      ...
      {name === "calendar" ? (
        <>
          ...
          <path d="M8 3.8V8M16 3.8V8M4.5 10h15M8 14h.01M12 14h.01M16 14h.01" {...common} />
        </>
      ) : null}
      {name === "trail" ? (
        <>
          <path d="M5 19c3.8-1.8 4-4.8 6.2-6.4 2-1.5 4.1-1.3 7.8-4.6" {...common} />
          <path d="m14.8 5.5 4.2 2.4-2.5 4.2M5 19h4M4.5 5.5h4v4h-4z" {...common} />
        </>
      ) : null}
    </svg>
  );
  ...
  return (
    <div className={styles.home} data-home-root>
      ...
      <main>
          ...
          <div className={styles.heroInner}>
            <div className={styles.heroCopy}>
              ...
              <p className={styles.heroLead}>
                Find useful businesses, places, events and local ideas across the
                Valleys through one clear, connected experience.
              </p>

              <form className={styles.searchForm} action="/businesses" method="get">
                <div className={styles.searchField}>
                  <span className={styles.searchIcon}>
                    <SearchIcon />
                  </span>
                  <span className={styles.searchFieldText}>
                    <label htmlFor="home-query">What are you looking for?</label>
                    <input
                      id="home-query"
                      name="q"
                      type="search"
            ...
            <div className={styles.heroVisual} data-home-parallax>
              <div className={styles.heroCanvas}>
                ...
                <section className={styles.localViewPanel} aria-label="Your local view preview">
                  ...
                  <div className={styles.localViewIntro}>
                    ...
                    <h2>Businesses, events and places that lead somewhere useful.</h2>
                  </div>
                  ...
                  <div className={styles.localViewList}>
                    ...
                    <Link
                      href={
                        (firstEvent ? `/events/${firstEvent.id}` : "/events") as Route
                      }
                    >
                    ...
                    <Link
                      href={
                        (firstArea ? `/places/${firstArea.slug}` : "/businesses") as Route
                      }
                    >
                      <span className={styles.localViewIndex}>03</span>
                      <span>
                        <small>Start with a place</small>
                        <strong>{firstArea?.name ?? "Explore the Valleys"}</strong>
                      </span>
                      <em>Explore area</em>
                    </Link>
                  </div>
        ...
        <section className={styles.profileBridge} data-home-reveal>
          <div className={styles.profileBridgeInner}>
            <div className={styles.profileBridgeCopy}>
              <p className={styles.eyebrow}>The part a directory usually misses</p>
              <h2>One profile. A complete local presence.</h2>
              <p>
                A business updates its information once. The same record can power
                search results, place pages and a polished website of its own.
              </p>
              <a href="#for-business">See how the business product works →</a>
            </div>
            <div className={styles.profileBridgeFlow} aria-label="One profile powers three surfaces">
              <div>
                <span>01</span>
        ...
        <section className={styles.categoriesSection} id="discover" data-home-reveal>
          <div className={styles.sectionInner}>
            <div className={styles.sectionHeading}>
              ...
              <p>
                Clear routes into local discovery, without making you learn how the
                platform is organised first.
              </p>
            </div>
        ...
        <section className={styles.discoverySection} data-home-reveal>
          <div className={styles.sectionInner}>
            <div className={styles.discoveryIntro}>
              ...
              <p>
                A useful business can lead to its website. An event can lead to a
                place. A guide can help turn a free afternoon into a plan.
              </p>
            </div>
            ...
            <div className={styles.discoveryLeadGrid}>
              <article className={styles.featuredBusiness}>
                ...
                >
                  <div className={styles.featuredArt}>
                    <span className={styles.featuredIndex}>Featured local business</span>
                    <CoilIllustration />
                  </div>
                  <div className={styles.featuredBody}>
                    <div className={styles.contentTopline}>
                      <span>{demoBusiness?.category.name ?? "Plumbing & heating"}</span>
                      <span>Demonstration profile</span>
                    </div>
                    <h3>{demoBusiness?.tradingName ?? "Browse local businesses"}</h3>
                    <p>
                    ...
                    <div className={styles.featuredMeta}>
                      <span>{demoBusiness?.place.name ?? "Rhondda Cynon Taf"}</span>
              ...
              <section className={styles.eventsPanel} id="events" aria-labelledby="events-title">
                ...
                <div className={styles.eventList}>
                  {discovery.eventsState === "ready" ? (
                    ...
                    <article className={styles.eventRow}>
                      <div className={styles.eventEmptyMark} aria-hidden="true">—</div>
                      <div className={styles.eventCopy}>
                        <h4>
                          {discovery.eventsState === "unavailable"
                        ...
                        <p>Open the events journey for the current public state.</p>
                      </div>
        ...
        <section className={styles.areasSection} id="areas" data-home-reveal>
          <div className={styles.sectionInner}>
            <div className={styles.sectionHeading}>
              ...
              <p>
                Choose a familiar place yourself. OurValleys does not need precise
                location permission to help you start nearby.
              </p>
            </div>
            ...
            {discovery.placesState === "ready" ? (
              ...
              <div className={styles.areaEmpty}>
                ...
                <p>Public business search remains available across all of RCT.</p>
        ...
        <section className={styles.guidesSection} id="guides" data-home-reveal>
          <div className={styles.sectionInner}>
            <div className={styles.guidesLayout}>
                  ...
                  {discovery.guidesState === "ready" ? (
                    discovery.guides.map((guide, index) => (
                      <article className={styles.guideRow} key={guide.slug}>
                        <Link href={`/guides/${guide.slug}` as Route}>
                          ...
                          <span className={styles.guideAction}>Read guide →</span>
                        </Link>
                      </article>
                    ))
                  ) : (
                    <article className={styles.guideRow}>
                      <Link href="/guides">
                        ...
                        <span className={styles.guideAction}>View guides →</span>
                      </Link>
                    </article>
                  )}
                </div>
              ...
              <aside className={styles.localMix} aria-labelledby="local-mix-title">
                <p className={styles.eyebrow}>More local businesses</p>
                <h2 id="local-mix-title">Different services, one clear language.</h2>
                <p>
            ...
            <p className={styles.demoNote}>
              <strong>About this demonstration:</strong> named business and guide
              examples are fictional and show intended product structure. Event
              previews use the public lifecycle projection. Nothing here implies
              real availability, popularity, verification or endorsement.
            </p>
          </div>
        </section>
              ...
              <ol className={styles.profileFlow}>
                ...
                <li>
                  ...
                  <div>
                    ...
                    <p>Search, categories and place routes reuse the same record.</p>
                  </div>
                </li>
                <li>
                  <span>03</span>
        ...
        <section className={styles.residentSection} data-home-reveal>
          <div className={styles.residentCta}>
            <div>
              ...
              <p>
                Public search and local discovery stay open. Create an account when
                you need protected business tools or a more personal journey.
              </p>
            </div>
      ...
      <footer className={styles.footer}>
        <div className={styles.footerInner}>
          <div className={styles.footerBrand}>
            ...
            <p>
              Independent local discovery and business websites for Rhondda Cynon
              Taf.
            </p>
        ...
        <div className={styles.footerLegal}>
          <p>
            OurValleys is independent and is not operated or endorsed by any council
            or public body.
          </p>
          <p>Fictional demonstration content is labelled and is not a real-world claim.</p>
        </div>
      </footer>
    </div>
  );
