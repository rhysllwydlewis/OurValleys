      ...
      <main className={styles.shell}>
        <div>
          ...
          <p className={styles.lead}>
            {publicDemo
              ? "This intentionally public demonstration is read-only at account level so its shared identity and access cannot be changed or deleted."
              : "Update your profile, choose whether we can contact you about updates, or permanently delete your account."}
          </p>
          <p className={styles.lead}>
        ...
        {publicDemo ? (
          <section className={styles.stateCard} role="note">
            <div>
              <p className={styles.eyebrow}>{publicDemo.label} demonstration</p>
              <h2>Public demo settings are read-only.</h2>
              <p>
                Name, image, preferences, credentials and account deletion are
                disabled. Sign out when you have finished exploring this shared
                development account.
              </p>
            </div>
          </section>
